...
Version History
v1.1.1.3 (current): Revised title, abstract, and added dynamical inconsistency argument (point attractor vs. limit cycle). Core results unchanged.
