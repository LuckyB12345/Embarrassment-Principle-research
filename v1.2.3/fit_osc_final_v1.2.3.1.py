...
def chi2_total(theta, z, mu, cov, bao, is_lcd):
    if is_lcd:
        ...
        A, b, Om, H0 = theta
        # 宽松边界：A 可到 1.0，b 保持在合理范围
        if not (0 <= A <= 1.0 and 10 <= b <= 50 and 0.15 <= Om <= 0.35 and 67 <= H0 <= 78):
            return 1e10
...
if __name__ == "__main__":
    print("="*70)
    print("v1.2.3.1 【包络函数】1+w = A sin(bz)/(1+z)² | 高红移绝对回归")
    ...
    bounds = [(0, 1.0), (10, 50), (0.15, 0.35), (67, 78)]
