...
def chi2_total(theta, z, mu, cov, bao, is_lcd):
    if is_lcd:
        ...
        # 稳妥边界：A∈[0,0.015]  alpha0∈[-8,0]
        if not (0 <= A <= 0.015 and -8 <= alpha0 <= 0 and 10 <= b <= 50 and 0.15 <= Om <= 0.35 and 67 <= H0 <= 78):
            return 1e10
...
if __name__ == "__main__":
    print("="*70)
    print("v2.2 【稳妥微调版】A上限0.015 | α₀仍-8~0 | 物理可控")
    print("✅ 高红移天然稳 | ✅ 低红移适度增强振荡 | ✅ 严守|1+w|先验")
    print("="*70)
    ...
    init = [0.002, -4.0, 18.0, 0.25, 72.0]
    # 关键微调边界
    bounds = [(0, 0.015), (-8, 0), (10,50), (0.15,0.35), (67,78)]
