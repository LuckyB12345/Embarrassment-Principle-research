...
Version History
v1.1.1.7 (current): Final official release. Aligns with the final peer-reviewed paper structure. All physical interpretations and conclusions finalized.
...
Acknowledgments
Large language models Doubao and DeepSeek provided auxiliary support for code development, data analysis, logical deduction and paper writing. The author retains full responsibility for all ideas, results and conclusions.