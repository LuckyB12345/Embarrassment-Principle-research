...
\noindent
\textbf{Relation to dynamical dark energy:}
This parametrization is structurally similar to \emph{damped oscillating quintessence} — a well-studied class of dynamical scalar field models.
However, our model is \emph{not} derived from a field-theoretic Lagrangian.
It is derived directly and minimally from the Embarrassment Principle,
making it a first-principle alternative to conventional field-theoretic constructions.
