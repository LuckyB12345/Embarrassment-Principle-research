...
Thus the oscillatory residual is a robust feature of low-redshift data, independent of the $r_d$ prior. We define the \emph{Embarrassment Principle} as the observation that low-redshift data, when freed from CMB priors, strongly prefer an undamped oscillating dark energy, and this preference disappears continuously and reversibly as $\Omega_m$ is forced toward the Planck value. The principle reflects a fundamental truth: the universe does not tend toward a static equilibrium; it oscillates forever.
